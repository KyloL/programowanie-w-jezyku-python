...
def main():
    l1 = Library(city="Radom", street="Radomska", zip_code="12-345",
                 open_hours=("pn - nieczynne", "wt 16 - 20", "śr 12 - 18"), phone="+48 1255645")
    l2 = Library(city="Kielce", street="Kielecka", zip_code="21-526",
    ...
    e1 = Employee("Kylo", "L", hire_date="2025-02-15", birth_date="2018-06-12", city="Gdynia", street="Gdyńska",
                  zip_code="12-345", phone="+48 1255645")
    e2 = Employee("Adam", "Z", hire_date="2024-01-15", birth_date="2048-06-12", city="Gdynia", street="Gdyńska",
                  zip_code="12-345", phone="+48 1255645")
    e3 = Employee("Bolo", "L", hire_date="2025-02-15", birth_date="2018-06-12", city="Gdynia", street="Gdyńska",
                  zip_code="12-345", phone="+48 1255645")
